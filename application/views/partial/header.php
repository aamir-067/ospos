...
<head>
	...
	<title><?php echo "Devsort Point of sale hub" . ' | ' . $this->lang->line('common_powered_by') . ' Devsort ' . $this->config->item('application_version') ?></title>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>">DPOSH</a>
				</div>
					...
					<ul class="nav navbar-nav navbar-right">
						<?php foreach($allowed_modules as $module): ?>
							<li class="<?php echo $module->module_id == $this->uri->segment(1) ? 'active' : ''; ?>">
								<a href="<?php echo site_url("$module->module_id"); ?>" title="<?php echo $this->lang->line("module_" . $module->module_id); ?>" class="menu-icon flex-row">
									<img src="<?php echo base_url() . 'images/menubar/' . $module->module_id . '.png'; ?>" border="0" alt="Module Icon"/><br/>
									<p><?php echo $this->lang->line("module_" . $module->module_id) ?></p>
								</a>
							</li>
						<?php endforeach; ?>
					</ul>
