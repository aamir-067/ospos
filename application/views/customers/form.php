...
<?php echo form_open($controller_name . '/save/' . $person_info->person_id, array('id'=>'customer_form', 'class'=>'form-horizontal')); ?>
	...
	<ul class="nav nav-tabs nav-justified" data-tabs="tabs">
		<li class="active" role="presentation">
			<p style="font-size:20px; color:#000; font-weight:bold;" data-toggle="tab" href="#customer_basic_info">Costumer Information</p>
		</li>

		<!-- <div style="" id="required_fields_message"><?php echo $this->lang->line('common_fields_required_message'); ?></div> -->
		<?php
		if(!empty($stats))
		{
		?>
				...
				<div class="form-group form-group-sm">
					...
					<div class='col-xs-8'>
						<?php echo form_input(array(
								...
								'id'=>'company_name',
								'class'=>'form-control input-sm',
								'placeholder'=>'e.g: Devsort Services',
